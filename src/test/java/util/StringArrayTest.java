...
public class StringArrayTest {
	...
	@Test
	public void split_string_with_deliminator_10() {
		String string = "| 1 | 4 | 5 | 7 |";
		String[] combinedString = util.StringArray.split(string, '|');
		assertEquals("", combinedString[0]);
		assertEquals(" 1 ", combinedString[1]);
		assertEquals(" 4 ", combinedString[2]);
		assertEquals(" 5 ", combinedString[3]);
		assertEquals(" 7 ", combinedString[4]);
		assertEquals("", combinedString[5]);
	}
